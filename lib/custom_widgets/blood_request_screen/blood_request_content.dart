...
class BloodRequestContent extends StatefulWidget {
  ...
  @override
  _BloodRequestContentState createState() => _BloodRequestContentState();
}
...
class _BloodRequestContentState extends State<BloodRequestContent> {
  ...
  Future<void> _pickImage(BuildContext context) async {
    ...
    if (photo != null) {
      ...
      final imageName = basename(photo.path);
      final reference = FirebaseStorage.instance.ref().child('bloodRequest/$imageName');
    ...
    return Column(
      ...
      children: [
        ...
        TimeBloodRequestContainer(
          selectedDate: selectedDate,
          screenWidth: screenWidth,
          onDateChanged: () => _selectDate(context),
        ),
        SizedBox(height: screenWidth * 0.07),
        Center(
          child: Container(
                ...
                return CustomButtonConnection(
                  ...
                  onPressed: () {
                    if (url != null && bloodBracketsCount != 0) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Please upload the image and specify blood brackets.')),
                      );
                    }
                  },
                );
